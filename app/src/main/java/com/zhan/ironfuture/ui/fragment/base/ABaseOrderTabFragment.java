 ...
 * 订单列表基类
 */
public abstract class ABaseOrderTabFragment extends ABaseTabFragment<ABaseOrderTabFragment.OrderInfo> {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ABaseOrderTabFragment.OrderInfo orderInfo = getAdapterItems().get((int) id);
