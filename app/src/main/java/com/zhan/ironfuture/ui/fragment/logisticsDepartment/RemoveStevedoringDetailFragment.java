...
import com.zhan.ironfuture.beans.RemoveLoadRequestBean;
 ...
 */
public class RemoveStevedoringDetailFragment extends ABaseFragment{
    private final static String ARG_KEY = "remove_stevedoringdetail";
    ...
    private RemoveStevedoringDetailContent content ;
    ...
    public static void launch(Fragment fragment,RemoveStevedoringDetailContent content,int requestCode) {
        FragmentArgs args = new FragmentArgs();
        args.add(ARG_KEY, content);
        FragmentContainerActivity.launchForResult(fragment, RemoveStevedoringDetailFragment.class, args, requestCode);
    }
    ...
    protected void layoutInit(LayoutInflater inflater, Bundle savedInstanceSate) {
        ...
        mIsHandling = content.getmIsHandling();
    }

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        content = savedInstanceState == null ? (RemoveStevedoringDetailContent) getArguments().getSerializable(ARG_KEY)
                : (RemoveStevedoringDetailContent) savedInstanceState.getSerializable(ARG_KEY);
    }
    ...
    public void onActionBarMenuClick() {
        if(isRequestProcessing(ApiUrls.REMOVE_LOADING)){
            return;
        }
        RemoveLoadRequestBean requestBean = new RemoveLoadRequestBean();
        List<RemoveLoadRequestBean.DataEntity> dataEntityList = new ArrayList<>();
        for(int i = 0;i<mDataList.size();i++){
            RemoveLoadRequestBean.DataEntity dataEntity = new RemoveLoadRequestBean.DataEntity();
        ...
        startJsonRequest(ApiUrls.REMOVE_LOADING, requestBean, new HttpRequestHandler(this) {
            @Override
                ...
                switch (resultCode) {
                    case success:
                        ...
                        if (bean != null) {
                            ...
                            //intent.putExtra(StevedoringFragment.KEY_PURCHASE_ORDER_COMPANY, 2);
    ...
    public void requestData() {
        ...
        startJsonRequest(ApiUrls.GETCARSADDINFO, requestBean, new BaseHttpRequestTask<StevedoringDetailResponseBean>() {
                    ...
                    protected void onSuccess(StevedoringDetailResponseBean bean) {
                        ...
                        if(bean != null && bean.getData() != null && bean.getData().getGoodsBack() != null){
