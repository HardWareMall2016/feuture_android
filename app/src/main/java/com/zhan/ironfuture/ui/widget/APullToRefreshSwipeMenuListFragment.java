 ...
 */
public abstract class APullToRefreshSwipeMenuListFragment<T> extends ARefreshFragment<T, ListView> {
    static String TAG = "APullToRefreshListFragment";

    @ViewInject(idStr = "pull_refresh_list")
    protected PullToRefreshSwipeMenuListView mPullToRefreshListView;
    ...
    final protected void setInitRefreshView(AbsListView refreshView, Bundle savedInstanceSate) {
        ...
        mPullToRefreshListView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<SwipeMenuListView>() {
            @Override
            public void onPullDownToRefresh(PullToRefreshBase<SwipeMenuListView> refreshView) {
                //下拉刷新
                initPullUpLable(true);
                APullToRefreshSwipeMenuListFragment.this.onPullDownToRefresh();
            }
            ...
            public void onPullUpToRefresh(PullToRefreshBase<SwipeMenuListView> refreshView) {
                ...
                APullToRefreshSwipeMenuListFragment.this.onPullUpToRefresh();
            }
        });
    ...
    protected void setInitPullToRefresh(ListView listView, PullToRefreshSwipeMenuListView pullToRefreshListView, Bundle savedInstanceState) {
