...
public abstract class ActionBarActivity extends AppCompatActivity{
    ...
    * */
    ...
    public void initActionbar(){
        mActionBarCustomerContent.removeAllViews();
        mActionBarRightContent.removeAllViews();
        mDefActionbarContent.setVisibility(View.VISIBLE);
        mActionBarCustomerContent.setVisibility(View.GONE);
        mTvMenu.setText("");
    }
    ...
    private void populateContentView(View userView) {
        /*初始化整个内容*/
        initContentView();
        /*初始化用户定义的布局*/
    ...
    public LinearLayout getActionBarRightContent(){
        return mActionBarRightContent;
    }

    public FrameLayout getActionBarCustomerContent(){
       return mActionBarCustomerContent;
    }

    public void setShowActionBarCustomerContent(boolean show){
        if(show){
