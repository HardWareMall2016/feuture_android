package com.zhan.framework.ui.widget;
...
public class RippleButton extends Button {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.RippleButton);
        rippleColor = typedArray.getColor(R.styleable.RippleButton_rv_color, 0xFFFFFF);
        rippleType = typedArray.getInt(R.styleable.RippleButton_rv_type, 0);
        hasToZoom = typedArray.getBoolean(R.styleable.RippleButton_rv_zoom, false);
        isCentered = typedArray.getBoolean(R.styleable.RippleButton_rv_centered, false);
        rippleDuration = typedArray.getInteger(R.styleable.RippleButton_rv_rippleDuration, rippleDuration);
        frameRate = typedArray.getInteger(R.styleable.RippleButton_rv_framerate, frameRate);
        rippleAlpha = typedArray.getInteger(R.styleable.RippleButton_rv_alpha, rippleAlpha);
        ripplePadding = typedArray.getDimensionPixelSize(R.styleable.RippleButton_rv_ripplePadding, 0);
        canvasHandler = new Handler();
        zoomScale = typedArray.getFloat(R.styleable.RippleButton_rv_zoomScale, 1.03f);
        zoomDuration = typedArray.getInt(R.styleable.RippleButton_rv_zoomDuration, 200);
        typedArray.recycle();
        paint = new Paint();
    ...
    public interface OnRippleCompleteListener {
        void onComplete(RippleButton rippleButton);
    }
